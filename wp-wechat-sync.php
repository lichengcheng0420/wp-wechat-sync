...
// 核心常量定义
define( 'WP_WECHAT_SYNC_VERSION', '1.1.0' );
...
final class WP_WeChat_Sync {
    ...
    private function includes() {
        ...
        require_once WP_WECHAT_SYNC_PATH . 'includes/class-message-server.php';
    ...
    private function init_hooks() {
        ...
        // 初始化微信公众号消息服务端 (开发模式与关键词回复)
        WP_WeChat_Message_Server::init();
